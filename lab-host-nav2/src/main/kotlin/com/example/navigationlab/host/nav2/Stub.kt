...
object Nav2HostProvider {
    ...
    /** All scenarios registered by this module (T2 + E01 + F01/F02). */
    val scenarios: List<LabScenario> = T2_SCENARIOS + E_T2_SCENARIOS + F_T2_SCENARIOS
...
object Nav2ToNav3InteropProvider {
    ...
    /** All scenarios registered by this provider (T7 topology). */
    val scenarios: List<LabScenario> = T7_SCENARIOS
