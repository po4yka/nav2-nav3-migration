 ...
 */
object Nav2HostProvider : LabHostProvider {
 ...
 */
object Nav2ToNav3InteropProvider : LabHostProvider {

    /** All scenarios registered by this provider (T7 + E09 + G06 cases). */
    override val scenarios: List<LabScenario> = T7_SCENARIOS + E_T7_SCENARIOS + G_T7_SCENARIOS
