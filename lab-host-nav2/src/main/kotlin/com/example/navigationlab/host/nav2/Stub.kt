...
object Nav2HostProvider {
    ...
    val scenarios: List<LabScenario> =
        T2_SCENARIOS + E_T2_SCENARIOS + F_T2_SCENARIOS + G_T2_SCENARIOS + H_T2_SCENARIOS
...
object Nav2ToNav3InteropProvider {
    ...
    /** All scenarios registered by this provider (T7 + G06 default-drift case). */
    val scenarios: List<LabScenario> = T7_SCENARIOS + G_T7_SCENARIOS
